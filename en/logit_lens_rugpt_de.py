...
import sys
sys.stdout = open('logit_lens_rugpt3_de.txt', 'w', encoding='utf-8')
...
test_strs = [
    "Der Kellner servierte dem Gast das Essen und stellte den Teller an ⟨blank⟩",
    "Die Bibliothekarin lieh dem Besucher das Buch und wünschte mit ⟨blank⟩ viel Spaß",
    "Der Chef überreichte den Mitarbeitern die Bonuszahlungen bei ⟨blank⟩",
    "Der Mechaniker erklärte die Installation für ⟨blank⟩",
    "Der Arzt überreichte der Patientin das Rezept an ⟨blank⟩",
    "Die Sekretärin schickte dem Kunden die Rechnung mit ⟨blank⟩",
]
